...
wire [31:0] Next_PCE;
assign Next_PCE = PCSrcE ? PCPlusImmE : PCPlus4E;
//////////////////////EX_mem////////////////////////////
wire RegWriteM;
wire MemWriteM;
wire [1:0]ResultDesM;
...
logic [3:0] rvfi_mem_mask;
 ...
 always_ff @(posedge clk or negedge rst) begin
    ...
    assign rvfi_rd_wdata  = (RegWriteW && RdM != 0) ? ResultW : 32'd0;
	...
	always_comb begin
	case(mem_maskW)
		3'b000: rvfi_mem_mask= 4'b0001;
		3'b001: rvfi_mem_mask= 4'b0011;
		3'b010: rvfi_mem_mask= 4'b1111;
	endcase
	end
    
    assign rvfi_mem_rmask = rvfi_mem_mask; 
    assign rvfi_mem_wmask = rvfi_mem_mask; 
	
    assign rvfi_mem_rdata = ReadDataW;
    assign rvfi_mem_wdata = WriteDataW;
